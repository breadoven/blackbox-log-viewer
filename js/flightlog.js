                        ...
                        switch (frameType) {
                            ...
                            case 'I':
                                ...
                                var numOutputFields = frame.length + slowFrameLength + ADDITIONAL_COMPUTED_FIELD_COUNT + gpsFrameLength;
                                    // numOutputFields = frame.length + slowFrameLength + ADDITIONAL_COMPUTED_FIELD_COUNT + 6;
                                ...
                                if (userSettings.logDataGps) {
                                    ...
                                    // for (var i = 0; i < 6; i++) {
                                        ...
                                        // destFrame[i + frame.length + slowFrameLength] = lastGPSData[i] === undefined ? null : lastGPSData[i + 1];
                                    }
                                }
